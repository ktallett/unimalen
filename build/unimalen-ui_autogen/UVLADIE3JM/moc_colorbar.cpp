...
void ColorBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ColorBar::*)(const QColor & )>(_a, &ColorBar::colorSelected, 0))
            return;
    }
}
...
// SIGNAL 0
void ColorBar::colorSelected(const QColor & _t1)
{
