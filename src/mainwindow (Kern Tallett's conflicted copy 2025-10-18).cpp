...
void MainWindow::createActions()
{
    ...
    m_aboutAction = new QAction(tr("&About Unimalen"), this);
...
{
    QMessageBox::about(this, tr("About Unimalen"),
        tr("<h2>Unimalen</h2>"
           "<p>Version 1.0.0</p>"
           "<p>A lightweight drawing and painting application designed for creating zines and digital artwork.</p>"
           "<p>Copyright © 2025</p>"
           "<p>Licensed under the GNU General Public License v3.0</p>"
           "<p><a href='https://github.com/yourusername/unimalen'>https://github.com/yourusername/unimalen</a></p>"));
}